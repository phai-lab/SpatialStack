...
###################################### ENV DIVIDER
OUTPUT_DIR="./output/spatialstack_train"              # Directory for saving checkpoints
...
# Model Configuration
# ======================
DATASETS="spar_234k%60,llava_hound_64k%60,vlm3r_scannet%60,vsi_appr_order%50"             # [DataArguments] Dataset list
